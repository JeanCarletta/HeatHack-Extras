...
s.to_csv("venue_7_electricity_downsampled.csv", encoding='utf-8')
...
d.to_csv("venue_7_electricity_by_day.csv", encoding='utf-8')

# save a one week extract of the full data

one_week_df = df[(df['timestamp'] > pd.to_datetime('2022-12-01T00:00:00+00:00')) & (df['timestamp'] < pd.to_datetime('2022-12-08T00:00:00+00:00'))]
#print(one_week_df.iloc[0])
#print(one_week_df.iloc[-1])

one_week_df.to_csv("venue_7_electricity_one_week_detail.csv", encoding='utf-8')
